...
#     1.0507
# ]
# checkpoint='E:\\daity\\mmsegmentation-at-af\\mmsegmentation\\checkpoints\\LTbANet-9851-usvinland-120k-640×640' \
#            '-iter_117600.pth '
...
default_hooks = dict(
    ...
    checkpoint=dict(
        type='CheckpointHook', by_epoch=False, interval=iters //50),
